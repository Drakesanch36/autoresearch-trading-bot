...
ExecStart=${INSTALL_DIR}/.venv/bin/python ${INSTALL_DIR}/run_trading_agent.py --loop-forever --provider auto --alpha-provider openai --alpha-model gpt-5.1-mini --protection-provider anthropic --protection-model claude-sonnet-4-20250514
Restart=always
RestartSec=10
TimeoutStopSec=30
